...
export const AetherFlowHero = ({ children }: { children?: React.ReactNode }) => {
    ...
    React.useEffect(() => {
        ...
        function init() {
            ...
            for (let i = 0; i < numberOfParticles; i++) {
                ...
                let color = 'rgba(191, 128, 255, 0.5)'; 
        ...
        const animate = () => {
            ...
            // clear rect instead of fillRect for transparent to allow Next.js background to show
